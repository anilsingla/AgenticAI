#!/usr/bin/env bash
#
# terminate.sh - Tear down all Azure resources for the production demo project.
#
# Usage: ./deployment/azure/terminate.sh
#
...
echo "============================================"
echo "  Terminating Production Demo Project on Azure"
echo "============================================"
echo ""
