...
dataAnalyst = Agent(
    role="Data Analyst",
    goal=("Create tables to analyze the gathered information and provide insights on the top 5 trends in the industry. The topic is - {topic}"),
    backstory=("You are a skilled data analyst with expertise in organizing and analyzing information. You have experience in creating tables and visualizations to identify patterns and trends in data. Your analytical skills are complemented by your ability to synthesize insights and present them in a clear and concise manner.    "),
    llm=llm,
    verbose=True,
)
...
result = crew.kickoff(inputs={"topic": "iphone in 2026 and return tabular data."})
print(result.raw)